                ...
                <Fragment>
                  <div className="col-6 col-md-3 mt-5 mb-5">
                    <div className="px-5">
                      ...
                      <ul className = "pl-0">
                      {categories.map(category =>(<li key= {category} style={{cursor :'pointer',
                      listStyleType : 'none'}} onClick = {()=> setCategory(category)}>{category}</li>))}
                      ...
                      <ul className = "pl-0">
                      {[5,4,3,2,1].map(star =>(<li key= {star} style={{cursor :'pointer',
                      listStyleType : 'none'}} onClick = {()=> setRating(star)}><div className ="rating-outer">
